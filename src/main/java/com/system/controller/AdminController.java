...
public class AdminController {
    ...
    //版本信息显示
    @RequestMapping(value = "/versionsInfo", method = {RequestMethod.GET})
    public String versionsInfoUI(Model model) throws Exception {
        return "admin/versionsInfo";
    }
    //院系显示
    @RequestMapping(value = "/collageInfo", method = {RequestMethod.GET})
    public String collageInfoUI(Model model) throws Exception {
        return "admin/collageInfo";
    }
    // 添加学生信息操作
