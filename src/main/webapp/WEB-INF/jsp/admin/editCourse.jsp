        ...
        <div class="col-md-9 " style="margin-left: 5%">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/admin/editCourse" id="editfrom" method="post" style="margin: 40px 23% 30px 15%">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label">课程开始时间</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" style="width: 50%" value="1970 - 01 - 01" name="startTime"/>
                            </div>
                        </div>
                        <div class="form-group">
