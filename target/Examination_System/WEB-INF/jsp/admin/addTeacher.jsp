        ...
        <div class="col-md-9 " style="margin-left: 5%">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/admin/addTeacher" id="editfrom" method="post" style="margin: 40px 23% 30px 15%">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="1996-09-02"  class="form-control" style="width: 50%" name="birthyear"/>
                            </div>
                        </div>
                        <div class="form-group">
