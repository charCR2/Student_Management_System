                            ...
                            <div class="row">
                                ...
                                <div >
                                    <select id="usertype" name="usertype" class="selectpicker show-tick form-control" title="分类" data-live-search="false">
                                        <option value=0>课名</option>
                                        <option value=1>课号</option>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-default btn-xs btn-danger btn-primary"
                                        onClick="confirmd(${item.courseid})">删除
                                </button>
                                <!--弹出框-->
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#usertype").change(function(){
            ...
            if(value==="0"){
                $("#subInput").attr("placeholder","请输入课程名")
            }else if(value==="1"){
                $("#subInput").attr("placeholder","请输入课程号")
            }else if(value==="2"){
                $("#subInput").attr("placeholder","请输入学院")
            }
        });
    });
    function confirmd(courseid) {
        var msg = "您真的确定要删除吗？！";
        if (confirm(msg) == true) {
